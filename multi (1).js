...
(function () {
  ...
  // ---------- entrada ----------
  Sala.telaEntrada(app, 'No Limite', './', (nome, codigo, criar) => {
  ...
  function topo(extra) {
    return `<div class="topbar"><span class="pill">Sala ${esc(sala.codigo)}${extra ? ' · ' + extra : ''}</span><a class="link-back" href="./">Sair</a></div>`;
  }
